...
func NewTouristAttractionTypeService(touristAttractionTypeRepository _interface2.TouristAttractionTypeRepository, validate *validator.Validate) TouristAttractionTypeService {
